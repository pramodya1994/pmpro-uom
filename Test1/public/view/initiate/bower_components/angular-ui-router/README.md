...
---
**[Download 0.2.17](http://angular-ui.github.io/ui-router/release/angular-ui-clientApp.js)** (or **[Minified](http://angular-ui.github.io/ui-router/release/angular-ui-router.min.js)**) **|**
...
**(1)** Get UI-Router in one of the following ways:
 ...
 - [download the release](http://angular-ui.github.io/ui-router/release/angular-ui-clientApp.js) (or [minified](http://angular-ui.github.io/ui-router/release/angular-ui-router.min.js))
...
**(2)** Include `angular-ui-clientApp.js` (or `angular-ui-router.min.js`) in your `index.html`, after including Angular itself (For Component users: ignore this step)
